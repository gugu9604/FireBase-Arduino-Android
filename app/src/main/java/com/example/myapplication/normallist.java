...
public class normallist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        normallistToolbar = findViewById(R.id.normallistToolbar);
        listview = findViewById(R.id.normallist);
        setSupportActionBar(normallistToolbar);
        ...
        normallistToolbar.setTitleTextColor(Color.BLACK);
        ...
        normallist.CustomAdapter adapter = new normallist.CustomAdapter(this,0,items);
